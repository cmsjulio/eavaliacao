...
public class DiscenteController extends BaseController {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "successful operation", response = DiscenteResponse.class),
   ...
   @ApiOperation(value = "Criar novo discente", nickname = "addDiscente", notes = "Criar discente")
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 204, message = "successful operation", response = DiscenteResponse.class),
            @ApiResponse(code = 400, message = "Bad Request"),
            @ApiResponse(code = 404, message = "Discente not found")})
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "successful operation", response = Discente.class, responseContainer = "List"),
            @ApiResponse(code = 400, message = "Bad Request")})
    ...
    public ResponseEntity<?> findAll(Pageable pageable) {
        ...
        List<DiscenteResponse> content = discentePage.stream()
                .map(item -> modelMapper.map(item, DiscenteResponse.class))
